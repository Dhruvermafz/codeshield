...
const EditPassword = (props: EditPasswordProps) => {
  ...
  return (
    <section
      className={`fixed z-50 inset-0 overflow-y-auto   bg-black bg-opacity-40`}
    >
      <div className="flex items-end sm:items-center justify-center min-h-full md:p-4 text-center sm:p-0">
        <div
          ...
          } rounded-lg m text-left shadow-xl transform transition-all sm:my-8`}
        >
          <div
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col ">
                <div>
                  <div
                    className={`flex justify-between items-center mb-2 my-1 `}
                  >
                    <label
                      htmlFor="password"
              ...
              <button
                ...
                className={`px-3 mt-4 py-2  ${
                  theme === "dark"
                    ? "bg-[#292929] text-[#73d285]"
                    : "bg-[#F8F8FF] text-[#73d285]"
                } border border-gray-500 rounded-lg hover:text-white  hover:bg-[#73d285]`}
              >
                Save
              </button>
